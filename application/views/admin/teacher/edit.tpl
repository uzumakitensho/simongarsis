...
{block name=breadcrumb}
	{include file="admin/teacher/breadcum.tpl" active='edit'}
{/block}

{block name=sidebar}
	{include file="admin/teacher/sidebar.tpl" active='edit'}
{/block}
...
<div class="col-md-10" style="min-height:515px;">
	...
	<h2>Edit Teacher</h2>
	<form class="form-horizontal" action="{base_url url='admin/teacher/edit' src=$teacher->id}" method="post">
		{* validation_errors *}
		<div class="form-group {form_error field='full_name' opt=1}">
			<label for="full_name" class="col-sm-2 control-label">Name</label>
			<div class="col-sm-10">
				<input type="hidden" name="id" value="{$teacher->id}">
				<input type="text" class="form-control" id="full_name" name="full_name" placeholder="Full Name" value="{$teacher->full_name}">
		...
		<div class="form-group {form_error field='nip' opt=1}">
			...
			<div class="col-sm-10">
				<input type="text" class="form-control" id="nip" name="nip" placeholder="NIP" value="{$teacher->nip}">
		...
		<div class="form-group {form_error field='born_date' opt=1}">
			...
			<div class="col-sm-10">
				<input type="date" class="form-control" id="born_date" name="born_date" placeholder="" value="{$teacher->born_date}">
		...
		<div class="form-group {form_error field='born_place' opt=1}">
			...
			<div class="col-sm-10">
				<input type="text" class="form-control" id="born_place" name="born_place" placeholder="" value="{$teacher->born_place}">
		...
		<div class="form-group {form_error field='gender' opt=1}">
			...
			<div class="col-sm-10">
				<select name="gender" class="form-control">
					<option value="L" {if $teacher->gender == 'L'} 'selected' {/if}>Male</option>
					<option value="P" {if $teacher->gender == 'P'} 'selected' {/if}>Female</option>
				</select>
		...
		<div class="form-group {form_error field='telephone' opt=1}">
			...
			<div class="col-sm-10">
				<input type="text" class="form-control" id="telephone" name="telephone" placeholder="Telephone" value="{$teacher->telephone}">
		...
		<div class="form-group {form_error field='role' opt=1}">
			...
			<div class="col-sm-10">
				...
				{foreach $roles as $key => $role}
					<option value="{$role->id}" {if $teacher->role_id == $role->id} 'selected' {/if}>{$role->description}</option>
				{/foreach}
				</select>
