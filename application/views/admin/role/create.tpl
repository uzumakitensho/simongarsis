...
{block name=breadcrumb}
	{include file="admin/parent/breadcum.tpl" active='create'}
{/block}

{block name=sidebar}
	{include file="admin/parent/sidebar.tpl" active='create'}
{/block}
...
<div class="col-md-10" style="min-height:515px;">
	...
	<h2>Create Parent</h2>
	<form class="form-horizontal" action="{base_url url='admin/parent/create'}" method="post">
		{* validation_errors *}
