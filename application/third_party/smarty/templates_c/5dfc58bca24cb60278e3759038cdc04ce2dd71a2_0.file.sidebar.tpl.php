...
/* Smarty version 3.1.28, created on 2016-04-29 19:20:04
  from "C:\xampp\htdocs\monitoring\application\views\admin\parent\sidebar.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.28',
  'unifunc' => 'content_572397c478c3e3_52870682',
  'file_dependency' => 
  array (
    '5dfc58bca24cb60278e3759038cdc04ce2dd71a2' => 
    array (
      0 => 'C:\\xampp\\htdocs\\monitoring\\application\\views\\admin\\parent\\sidebar.tpl',
      1 => 1461950020,
      2 => 'file',
    ),
  ),
...
function content_572397c478c3e3_52870682 ($_smarty_tpl) {
...
<div class="col-md-2" style="padding-left: 0px; padding-right: 0px;">
	<div class="list-group">
		...
		<a href="<?php echo smarty_function_base_url(array('url'=>'admin/parent'),$_smarty_tpl);?>
" class="list-group-item <?php if ((isset($_smarty_tpl->tpl_vars['active']->value) && $_smarty_tpl->tpl_vars['active']->value == 'list')) {?> <?php echo 'active';?>
 <?php }?>" style="border-radius: 0px;">
		...
		<a href="<?php echo smarty_function_base_url(array('url'=>'admin/parent/create'),$_smarty_tpl);?>
" class="list-group-item <?php if ((isset($_smarty_tpl->tpl_vars['active']->value) && $_smarty_tpl->tpl_vars['active']->value == 'create')) {?> <?php echo 'active';?>
 <?php }?>" style="border-radius: 0px;">Create Parent</a>
...
" class="list-group-item <?php if ((isset($_smarty_tpl->tpl_vars['active']->value) && $_smarty_tpl->tpl_vars['active']->value == 'edit')) {?> <?php echo 'active';?>
 <?php }?>" style="border-radius: 0px;">Edit Parent</a>
		<?php }?>
	</div>
</div><?php }
}
